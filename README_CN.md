...
| 首页                                         | 工作台                                           |
| -------------------------------------------- | ------------------------------------------------ |
| ![首页](docs/assets/screenshots/landing.png) | ![工作台](docs/assets/screenshots/dashboard.png) |

| 练习中心                                          | 知识点体系                                           |
| ------------------------------------------------- | ---------------------------------------------------- |
| ![练习中心](docs/assets/screenshots/practice.png) | ![知识点体系](docs/assets/screenshots/knowledge.png) |

| 模拟考试                                      | 学习计划                                      |
| --------------------------------------------- | --------------------------------------------- |
| ![模拟考试](docs/assets/screenshots/exam.png) | ![学习计划](docs/assets/screenshots/plan.png) |

| 学情诊断                                          |
| ------------------------------------------------- |
| ![学情诊断](docs/assets/screenshots/analysis.png) |
